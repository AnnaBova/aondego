        ...
        <div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myRegister" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content modal-popup">
                    ...
                    $register = new frontend\models\Client;
...
<!--                    <form action="#" class="popup-form" id="myRegister">
	    ...
	    <!-- Extras Modal -->
<div class="modal fade" id="voucher-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-popup">
            
            <form method="get" action="<?php echo Yii::$app->urlManager->createUrl('merchant/search')?>" name="review" id="review" class="popup-form">  
                <div id="custom-search-input">
                    <div class="input-group ">
                        <input type="text" class=" search-query" placeholder="<?php echo Yii::t('basicfield', 'Postal code / City')?>" id="search" name="Merchant[search]" required>
		...
		<input id="voucher" value="voucher" class="form-control form-white" type="hidden"  autofocus="" name="Merchant[type]">
...
<div class="modal fade" id="browse-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        $this->registerJs("
            var socket = io.connect('http://82.165.206.110:3000/', {rejectUnauthorized: false});
