		...
		<table class="table table_summary">
			...
			foreach ($cart as $key => $value) {
				...
				<tr>
				    ...
				    <td>
					<strong class="pull-right">€ <?php echo \frontend\components\UrlHelper::numberFormat($value['price']); ?></strong>
				    </td>
				</tr>
			...
			<tr>
			    ...
			    <td>
				<strong class="pull-right">€ <?php echo $subtotal?></strong>
			    </td>
			</tr>
			<tr>
			    <td>
			    ...
			    <td>
				<strong class="pull-right">€ <?php echo frontend\components\UrlHelper::numberFormat($order->delivery_fee)?></strong>
			    </td>
			</tr>
			<tr>
