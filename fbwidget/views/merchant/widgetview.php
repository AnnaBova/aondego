...
$this->registerJsFile('http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.1/i18n/jquery-ui-i18n.min.js',
					...
					<div class="col-md-12">
						<div id="general_rating">
							...
							<div class="general_rating">
								<h4 class="nomargin_top"><?php echo Yii::t('basicfield', 'Gift voucher'); ?> <i class="icon-gift pull-right"></i></h4>
								<p><?php
