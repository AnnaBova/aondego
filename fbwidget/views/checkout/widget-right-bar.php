    ...
    <table class="table table_summary">
        <tbody>
            <tr>
                <td>
                    <?php echo Yii::t('basicfield','Subtotal');?> <span class="pull-right">€ <?php echo number_format($session['subtotal'], 2, '.', '')?></span>
                </td>
            </tr>
            ...
            <tr>
                <td class="total">
                    ...
                    <?php echo Yii::t('basicfield','TOTAL')?> <span class="pull-right">€ <?php 
