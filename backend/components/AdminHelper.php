...
//                            'url' => array('/emailtpl'), 'active' => Yii::$app->controller->id == 'emailtpl'),
			...
			array('visible' => self::AA('currency'), 'tag' => "currency",
                            'label' => '<i class="fa fa-plus"></i>' . Yii::t("basicfield", "Add Currency"),
                            'url' => array('/currency'), 'active' => Yii::$app->controller->id == 'currency'),
                ...
                [ //'tag' => "rpt-merchante-sales",
                    'label' => '<i class="fa fa-mobile"></i>'. Yii::t("basicfield", "Sms Template"),
                    'url'=>['/smstpl/customer'],
                ...
                array('visible' => self::AA('rpt-merchante-sales'),
                    'tag' => "rpt-merchante-sales",
                    'label' => '<i class="fa fa-home"></i>'. Yii::t("basicfield", "Merchant Sales Report"),
                    'url' => array('/rpt-merchante-sales'),
                    'active' => Yii::$app->controller->id == 'rpt-merchante-sales'),


//                array(
//                    'visible' => self::AA('reports'),
...
//                    )),
                ...
                array('visible' => self::AA('admin-user'),
                    ...
                    'url' => array('/admin-user')),
                     ...
                     [ //'tag' => "rpt-merchante-sales",
                    'label' => '<i class="fa fa-home"></i>'. Yii::t("basicfield", "Database"),
