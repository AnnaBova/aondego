...
use backend\modules\backup\models\UploadForm;
use Yii;
...
//	}
	...
	public $homeUrl = '/dashboard';
	public $pageDescription = '';
	public $pageKeywords = '';
	public $baseUrl = '/administrator';
	public $logo_url = '/administrator';
	public $app_name = 'Administrator Default';
        public $menu;
	...
	public function actionDownload($file = null)
	{
		...
		$this->updateMenuItems();
                ...
                $file ='db_backup_2017.01.01_10.22.02.sql';
...
//                    }
	...
	public function actionIndex()
	{
		...
		$dataProvider = new ArrayDataProvider([  
                    'allModels' => $dataArray,
                    'sort' => [
                       'attributes' => ['name', 'size','create_time'],
                   ],]);               
