...
$this->title = Yii::t('basicfield', 'Merchants');
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="box">
    <div class="box-header">
        <h1 class="box-title"><?=Yii::t('basicfield','Manage')?> <?= Yii::t('basicfield','Merchants')?></h1>
    </div>
    <div class="box-body">
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'membership_expired',
                ...
                array(
                    ...
                    'filter' => array('1' => 'Yes', '0' => 'No'),
                    'value' => function($model){
                        return $model->is_activate ? "Yes" : "No";
                    }
                ),
                array(
                    ...
                    'filter' => array('1' => 'Yes', '0' => 'No'),
                    'value' => function($model){
                        return $model->is_purchase ? "Yes" : "No" ;
                    }
                ),
                array(
                    'attribute' => 'is_ready',
