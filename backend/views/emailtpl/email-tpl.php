<?php $this->breadcrumbs=array(
    Yii::t('default','Email Tpl'),
);
?>
    <h1><?= Yii::t('default','Email Templates')?></h1>
...
?>
    <h3><?php echo Yii::t('default',"customer welcome email template")?></h3>
<?php
echo $form->textFieldGroup($model,'values[email_tpl_customer_subject]',
    array(
        'placeholder' => "Email Subject"
    ),array('label'=>'Email Subject'));
?>

<?php $this->widget('ImperaviRedactorWidget', array(
    // You can either use it for model attribute
    'model' => $model,
    'attribute' => 'values[email_tpl_customer_reg]',
)); ?>
...
<hr/>
    <h3><?php echo Yii::t('default',"merchant activation email template")?></h3>


<?php $this->widget('ImperaviRedactorWidget', array(
    // You can either use it for model attribute
    'model' => $model,
    'attribute' => 'values[email_tpl_activation]',
)); ?>
...
<hr/>
    <h3><?php echo Yii::t('default',"merchant forgot password email template")?></h3>
<?php $this->widget('ImperaviRedactorWidget', array(
    // You can either use it for model attribute
    'model' => $model,
    'attribute' => 'values[email_tpl_forgot]',
)); ?>
