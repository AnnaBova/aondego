        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
				...
				<?php echo $form->field($model, 'staff_id')
                        ->dropDownList(\yii\helpers\ArrayHelper::map(Yii::$app->user->identity->staff, 'id', 'name'),array(
			...
			$yiiFormat = \common\components\Helper::getDateFormatYii(\common\components\Helper::dateFormat());?>
						...
						'onSelect' => new \yii\web\JsExpression("
							function(dateText, inst) { 
								...
								'success' : function(data){
									...
									$('#free_time_list-dis').html(data.dd); 
								}
                ...
                <?php echo $form->field($model, 'free_time_list')->hiddenInput([
                        'id' => 'free_time_list',  'required'=>'required',
                       ]); ?>
				<ul class="timeslot" id="free_time_list-dis">  </ul>
