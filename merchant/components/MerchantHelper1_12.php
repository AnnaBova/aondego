        ...
        return array(
            ...
            'items' => array(
                ...
                array(
                    ...
                    'options' => array('class' => ' ' . (in_array(Yii::$app->controller->action->id, ['index', 'additional', 'username', 'social', 'gallery', 'admin']) && Yii::$app->controller->id == 'merchant-edit' ? 'active' : '')),
                    'url' => '#',
			...
			array('visible' => self::hasMerchantAccess("Merchant"), 'active' => Yii::$app->controller->action->id == 'index', 'tag' => "Administration info", 'label' => '<i class="fa fa-eye"></i>' . Yii::t("basicfield", "Appointment Cancel Setup"),
