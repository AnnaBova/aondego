(function ($) {
    ...
    function galleryManager(el, options) {
        ...
        if (opts.hasName || opts.hasDesc) {
            photoTemplate += '<span class="editPhoto btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span> ';
        }

        photoTemplate += '<span class="deletePhoto btn btn-danger btn-xs"><i class="fa fa-trash" aria-hidden="true"></i></span>' +
