...
//                'class' => 'site.common.extensions.CAdvancedArBehavior'),
	...
	{
		return array(
			'category_id' => Yii::t('app','Subcategory'),
            'cat_id' => Yii::t('app','Category'),
			'merchant_id' => Yii::t('app','Merchant'),
			'price' => Yii::t('app','Price'),
            'time_in_minutes'=>Yii::t('app','Time in minutes'),
            'additional_time' => Yii::t('app','Additional Time'),
            'service_time_slot' => Yii::t('app','Service Time Slot'),
            'addon_list' =>Yii::t('app','Add-ons'),
            'group_people' => Yii::t('app','Peoples In Group'),
