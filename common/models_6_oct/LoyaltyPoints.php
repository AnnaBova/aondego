...
class LoyaltyPoints extends ActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'count_on_order' => Yii::t('app','Count On Order'),
			'count_on_like' => Yii::t('app','Count On Like'),
			'is_active' => Yii::t('app','Is Active'),
			'count_on_comment' => Yii::t('app','Count On Comment'),
			'count_on_rate' => Yii::t('app','Count On Rate'),
		);
	}
