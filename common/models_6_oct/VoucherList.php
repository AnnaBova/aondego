 ...
 */
class VoucherList extends ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return [
			[['voucher_id', 'voucher_code', 'client_id', 'date_used', 'order_id'], 'required'],
			[['voucher_id', 'client_id', 'order_id'],'integer'],
			[['voucher_code', 'status', 'date_used'], 'string', 'max'=>50],
