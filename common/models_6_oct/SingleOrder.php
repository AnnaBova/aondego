...
class SingleOrder extends Order {
    ...
    {
        $query->andWhere('is_group= 0 AND status!=2');
     }
     
    public static function find()
    {
        return parent::find()->where('is_group= 0 AND status!=2');
    ...
    {
        return array(
            'condition'=> 'is_group= 0 AND status!=2',
        );
    }
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['order_time', 'order_date', 'addons_list', 'memcache_key'], 'safe'],
