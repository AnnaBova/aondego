...
class Packages extends ActiveRecord
{
	...
	{
		return array(
			'package_id' => Yii::t('app','ID'),
			'title' => Yii::t('app','Title'),
			'description' => Yii::t('app','Description'),
			'price' => Yii::t('app','Price'),
			'promo_price' => Yii::t('app','Promo Price'),
			'expiration' => Yii::t('app','Expiration Days'),
			'expiration_type' => Yii::t('app','Expiration Type'),
			'unlimited_post' => Yii::t('app','Post Limit Type'),
			'post_limit' => Yii::t('app','Post Limit'),
			'sequence' => Yii::t('app','Sequence'),
			'status' => Yii::t('app','Is Active'),
			'date_created' => Yii::t('app','Date Created'),
			'date_modified' => Yii::t('app','Date Updated'),
			'sell_limit' => Yii::t('app','Sell Limit'),
            'workers_limit' => Yii::t('app','Workers Limit'),
