...
class ClientCc extends ActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'card_name' => Yii::t('basicfield','Card Name'),
			'credit_card_number' => Yii::t('basicfield','Credit Card Number'),
			'expiration_month' => Yii::t('basicfield','Expiration Month'),
			'expiration_yr' => Yii::t('basicfield','Expiration Yr'),
			'cvv' => Yii::t('basicfield','Cvv'),
			'billing_address' => Yii::t('basicfield','Billing Address'),
