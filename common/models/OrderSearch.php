...
class OrderSearch extends Order
{
    ...
    public function rules()
    {
        return [
            ...
            [['client_name', 'client_phone', 'client_email', 'order_time', 'create_time', 'more_info', 'voucher_code', 'voucher_type', 'commission', 'fromTo','is_service_gift'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
			...
			'is_service_gift'=>$this->is_service_gift,
        ]);
        ...
        if(isset($this->commission) ){
            ...
            if($this->commission == 1){
                //echo $this->commission;exit;
                $query->andFilterWhere([ 'total_commission'=> 0]);
            }else if($this->commission == 2){
