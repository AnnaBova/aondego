 ...
 */
class GroupTimeRange extends ActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'time_start' => Yii::t('basicfield','Time Start'),
			'group_schedule_days_template_id' => Yii::t('basicfield','Group Schedule Days Template'),
		);
	}
	...
	public function afterFind()
	{
		...
		$this->time_start = date("$timeFormat", strtotime($this->time_start));
