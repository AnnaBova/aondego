...
/**
 * mtCustomPageSearch represents the model behind the search form about `frontend\models\MtCustomPage`.
 */
class mtCustomPageSearch extends MtCustomPage
{
    /**
     * @inheritdoc
     */
