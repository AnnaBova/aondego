...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function getCoupone()
    {
        return $this->hasOne(MtVoucher::className(), ['voucher_id' => 'voucher_id']);
    }
    ...
    public static function getPrice($model){
        ...
        $price = $price - $model->loyalty_points_amount;
    ...
    public static function getCommision($merchantId, $total){
        ...
        $adminCommission =  \frontend\models\Option::getValByName('admin_commission_type');
        $commissionOnTotalOrSub = \frontend\models\Option::getValByName('commission_total_order');
            ...
            if($merchant->commission_type == 3){
                ...
                $commissionPer = \frontend\models\Option::getValByName('admin_commission_percent');
                $commissionFixed = \frontend\models\Option::getValByName('admin_commission_fixed_val');
            }
