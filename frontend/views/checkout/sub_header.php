<div id="sub_content">
	...
	if(isset($type) && $type == 'voucher'){
		echo Yii::t('basicfield', 'Order your voucher');
	}else{
	    echo Yii::t('basicfield', 'Book your appointment');
	}?>
    </h1>
    <div class="bs-wizard">
        <?php if(Yii::$app->controller->action->id == 'index' || Yii::$app->controller->action->id == 'voucher'){
           $yourDetail = 'active'; 
           $payment = 'disabled';
           $finish = 'disabled';
        }else if(Yii::$app->controller->action->id == 'payment'|| Yii::$app->controller->action->id == 'voucher-payment'){
           $yourDetail = 'complete'; 
           $payment = 'active';
           $finish = 'disabled';
        }else{
