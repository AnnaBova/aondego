			...
			<div class="col-md-5">
				<div class="box_style_2">
					...
					<div class="payment_select" id="paypal">
						<label><input type="radio" value="0" name="payment_method" class="icheck">Pay with paypal</label>
					</div>
					<div class="payment_select nomargin">
                                            <label><input type="radio" value="1" name="payment_method" class="icheck" checked="checked">Pay with cash</label>
				...
				<?php echo $this->render('right_bar'); ?>
                                ...
                                <div class="row" id="options_2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label><input type="radio" value="" name="option_2" class="icheck" >
                                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['mt-custom-page/view', 'slug'=> 'term-and-condition'])?>">
                                                    I agree with the general terms
                                                    </a>
                                                </label>
                                        </div>
                                ...
                                <hr>					
                                <a class="btn_full" href="javascript:void(0)" id="proceed-checkout">Proceed Checkout</a>
                            </div>
			</div><!-- End col-md-3 -->
