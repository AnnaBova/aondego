...
<div id="position">
	<div class="container">
		<?php echo $this->render('sub_header_widget')?>
	</div>
</div><!-- Position -->
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div id="cart_box">
				...
				<p><?php echo Yii::t('basicfield', "If you have already made an appointment before please login as an existing customer.");?></p>
				...
				<p><?php echo Yii::t('basicfield','Forgot Password?')?></p>
					
				<div class="form-group">
					<?= Html::a(Yii::t('basicfield', 'Please click here'), ['site/request-password-reset'], ['class' => 'btn btn-primary', 'name' => 'login-button', 'target' => '_blank']) ?>
				</div>
