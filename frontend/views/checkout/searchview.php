...
if(isset($session['latlang'])){
    ...
    foreach ($models as $model){
        ...
        echo "markersData[$i] = {
                ...
                'type_point': '".$service."',
                'description_point': '".$model['address']."<br><strong>Opening time</strong>: 09am-10pm.',
...
<div class="strip_list last wow fadeIn" data-wow-delay="0.6s">
        ...
        <div class="col-md-9 col-sm-9">
            <div class="desc">
                <div class="thumb_strip img-responsive">
                    <a href="<?php echo Yii::$app->urlManager->createUrl(['merchant/view', 'id'=>$model['merchant_id']])?>">
 ...
 ?>
                ...
                <h3><a href="<?php echo Yii::$app->urlManager->createUrl(['merchant/view', 'id'=>$model['merchant_id']])?>">
...
//                    
                ...
                ?>
                <i class="icon-heart"></i> Treuepunkte <span  class="label label-success"><i class="icon_check_alt2 ok"></i> </span>
<!--                <ul>
                    <?php /*
                ...
                <i class="icon-euro"></i> Aktion <span  class="label label-success"><i class="icon_check_alt2 ok"></i> </span>
<!--                <span class='opening'>Loyality Points</span>
                        ...
                        <table class="table table-striped cart-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="options">
                                        <a href="<?php echo Yii::$app->urlManager->createUrl(['merchant/view', 'id'=>$model['merchant_id']])?>"><i class="icon_plus_alt2"></i></a>
                                    </td>
                                </tr>
        ...
        <div class="col-md-3 col-sm-3">
            <div class="go_to">
                <div>
                    <a href="<?php echo Yii::$app->urlManager->createUrl(['merchant/view', 'id'=>$model['merchant_id']])?>" class="btn_1">
