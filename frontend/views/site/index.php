...
<!-- SubHeader =============================================== -->
<section class="parallax-window" id="home" data-parallax="scroll" data-image-src="<?php echo Yii::$app->request->hostInfo;?>/img/sub_header_home.jpg" data-natural-width="1600" data-natural-height="850">
    <div id="subheader">
...
<?php 
    $sql = 'SELECT status, is_activate,LCASE(city) as city from mt_merchant where status=1 AND is_activate=1 group by city';
...
<div class="container margin_60">
    ...
    <?php echo $this->render('merchant-cities', ['model' => $query]); ?>
