...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-9 ">
		    ...
		    <li>
                        <a data-toggle="tab" href="#voucher">
                            <i class="ion-card"></i> <span><?php echo Yii::t('basicfield', 'Voucher')?></span>
                        </a>
                    </li>
...
//                                 'filterModel' => $searchModel,
						...
						if($model->status == 2){
							return Yii::t('basicfield', 'Cancelled');
						}
                                                else if((date('Y-m-d',  strtotime($model->order_time)) > date('Y-m-d')) ){
			...
			<div class="box-grey rounded section-order-history tab-pane fade " style="margin-top:0;" id="voucher">

                            <div class="bottom10">
                                <div class="section-label">
                                    <a class="section-label-a">
                                        <span class="bold">
                                            <?php echo Yii::t('basicfield', 'Your Recent Voucher')?></span>
                                        <b></b>
                                    </a>     
                                </div>    
                            </div>
                           
			    <?php echo $this->render('voucher', [
...
<?php
    yii\bootstrap\Modal::begin([
        'header' => Yii::t('basicfield', 'Cancel Appointment'),
        'id'=>'cancelModalId',
    ]);
