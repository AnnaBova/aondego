 ...
 */
class StaffScheduleHasTimeRange extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('staff_schedule_id, time_range_id', 'required'),
			array('staff_schedule_id, time_range_id, status', 'numerical', 'integerOnly'=>true),
	...
	{
		return array(
			'staff_schedule_id' => Yii::t('default','Staff Schedule'),
			'time_range_id' => Yii::t('default','Time Range'),
