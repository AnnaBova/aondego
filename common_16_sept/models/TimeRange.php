 ...
 */
class TimeRange extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('schedule_days_template_id', 'numerical', 'integerOnly'=>true),
			array('time_from, time_to, additional_time', 'length', 'max'=>45),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'time_from' => Yii::t('default','Time From'),
			'time_to' => Yii::t('default','Time To'),
