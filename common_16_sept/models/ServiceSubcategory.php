...
class ServiceSubcategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, title, url', 'required'),
			array('category_id, is_active, is_approved, merchant_id, is_group', 'numerical', 'integerOnly'=>true),
			...
			array('id, category_id, title, description, is_active, is_approved, approved_text, date_created, date_updated, merchant_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'is_group' => Yii::t('default','Group Service')
		);
	}
