 ...
 */
class MerchantUser extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, first_name, last_name, username, password, user_access, date_created, date_modified, last_login, ip_address, contact_email, session_token', 'required'),
			array('merchant_id', 'numerical', 'integerOnly'=>true),
			array('first_name, last_name, username, password, contact_email, session_token', 'length', 'max'=>255),
	...
	{
		return array(
			'merchant_user_id' => Yii::t('default','Merchant User'),
			...
			'user_access' => Yii::t('default','User Access'),
