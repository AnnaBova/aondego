 ...
 */
class LoyaltyPoints extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, count_on_order, count_on_like, is_active, count_on_comment, count_on_rate', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, merchant_id, count_on_order, count_on_like, is_active, count_on_comment, count_on_rate', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'count_on_order' => Yii::t('default','Count On Order'),
			'count_on_like' => Yii::t('default','Count On Like'),
			'is_active' => Yii::t('default','Is Active'),
			'count_on_comment' => Yii::t('default','Count On Comment'),
			'count_on_rate' => Yii::t('default','Count On Rate'),
		);
	}
