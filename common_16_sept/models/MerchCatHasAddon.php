 ...
 */
class MerchCatHasAddon extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('m_c_id, addon_id', 'required'),
			array('m_c_id, addon_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, m_c_id, addon_id', 'safe', 'on'=>'search'),
		);
	}
