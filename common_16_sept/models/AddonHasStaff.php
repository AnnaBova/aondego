 ...
 */
class AddonHasStaff extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('staff_id, addon_id', 'required'),
			array('staff_id, addon_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, staff_id, addon_id', 'safe', 'on'=>'search'),
		);
	}
