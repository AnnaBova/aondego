 ...
 */
class MerchantCc extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, card_name, credit_card_number, expiration_month, expiration_yr, cvv, billing_address, date_created, ip_address', 'required'),
