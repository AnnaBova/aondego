 ...
 */
class ClientCc extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('client_id, card_name, credit_card_number, expiration_month, expiration_yr, cvv, billing_address, date_created, date_modified, ip_address', 'required'),
			array('client_id', 'numerical', 'integerOnly'=>true),
			array('card_name, billing_address', 'length', 'max'=>255),
			array('credit_card_number, cvv', 'length', 'max'=>20),
			array('expiration_month, expiration_yr', 'length', 'max'=>5),
