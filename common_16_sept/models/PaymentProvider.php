 ...
 */
class PaymentProvider extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('payment_name, payment_logo', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'payment_name' => Yii::t('default','Payment Name'),
			'payment_logo' => Yii::t('default','Payment Logo'),
